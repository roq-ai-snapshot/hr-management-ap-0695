...
import { useApplicantFindFirst } from 'lib/roq';
...
function ApplicantViewPage() {
  ...
  const { data, error, isLoading } = useApplicantFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('applicant', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/applicants/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem
                  ...
                  text={data?.application_date ? format(data?.application_date, 'dd-MM-yyyy') : ''}
                />
