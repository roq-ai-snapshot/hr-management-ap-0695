      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'years_experience',
              isInvalid: !!formik.errors?.years_experience,
            }}
            name="years_experience"
            error={formik.errors?.years_experience}
            value={formik.values?.years_experience}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('years_experience', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
